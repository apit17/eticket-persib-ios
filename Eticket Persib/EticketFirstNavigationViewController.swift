//
//  EticketFirstNavigationViewController.swift
//  Eticket Persib
//
...
class EticketFirstNavigationViewController: UINavigationController {
    ...
    override func viewDidLoad() {
        ...
        self.navigationBar.titleTextAttributes = [NSForegroundColorAttributeName : UIColor.blue]
